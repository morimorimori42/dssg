...
if __name__ == "__main__":
    ## automatically run the options for each scenario
    ## possible disassembly directions for each case
    d_dir = [1, 2, 3, 4, 5, 6]
    final_emissions_data = []

    for d in d_dir:
        ## define target component t
        t = 1
        ...
        final_emissions_data.append(final_emissions)
